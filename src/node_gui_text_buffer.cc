...
void TextBuffer::Init (Handle<v8::Object> target) {
    ...
    OUTTER_METHOD (TextBuffer, "getStartIter", gtk_text_buffer_get_start_iter, GtkTextIter *);
    OUTTER_METHOD (TextBuffer, "getEndIter", gtk_text_buffer_get_end_iter, GtkTextIter *);
